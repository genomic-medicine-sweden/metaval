...
1. **Flag taxpasta**
   - Flag taxonomy tables generated by `taxpasta` to identify likely present species based on the negative control. This step is crucial for filtering out false positives and background contamination from the results of metagenomics classifiers .
